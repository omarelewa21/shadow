...
<head>
    ...
    <title>{{ $title }}</title>
    <!-- Favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="/storage/{{$companyInfo->tab_icon}}" />
    <link rel="icon" type="image/png" sizes="32x32" href="/storage/{{$companyInfo->tab_icon}}" />
    <link rel="icon" type="image/png" sizes="16x16" href="/storage/{{$companyInfo->tab_icon}}" />
    <link rel="manifest" href="/storage/{{$companyInfo->tab_icon}}" />
